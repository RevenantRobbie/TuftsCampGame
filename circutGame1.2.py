...
class connectorNode:
    ...
    def redrawSelf(self):
        ...
        if self.inputOutput == "input1":
            self.shape = pygame.Rect(self.parent.shape[0]*5/4 + , self.parent.shape[1]+100, 15, 15)
        elif self.inputOutput == "input2":
            self.shape = pygame.Rect(self.parent.shape[0]*7/4, self.parent.shape[1]+100, 15, 15) #input2
        elif self.inputOutput == "output":
            self.shape = pygame.Rect(self.parent.shape[0]*6/4, self.parent.shape[1]-15, 15, 15)
